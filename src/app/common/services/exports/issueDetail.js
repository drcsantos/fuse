(function() {
  ...
  function exportIssueDetail($filter, imageData) {
    ...
    function exportPdf(data) {
      ...
      doc.roundedRect(
        188, // x position
        281, // y position | bigger is lower on page
        224, // x length
        18, // y height
        7, 7, // rounded corners
        'F'); // F filled | FD filled with borders

      doc.ellipse(580, 290, 2, 2, 'F');
      doc.ellipse(570, 290, 2, 2, 'F');
      doc.ellipse(560, 290, 2, 2, 'F');
      doc.ellipse(550, 290, 2, 2, 'F');
      doc.ellipse(540, 290, 2, 2, 'F');
      doc.ellipse(530, 290, 2, 2, 'F');
      doc.ellipse(520, 290, 2, 2, 'F');
      doc.ellipse(510, 290, 2, 2, 'F');
      doc.ellipse(500, 290, 2, 2, 'F');
      doc.ellipse(490, 290, 2, 2, 'F');
      doc.ellipse(480, 290, 2, 2, 'F');
      doc.ellipse(470, 290, 2, 2, 'F');
      doc.ellipse(460, 290, 2, 2, 'F');
      doc.ellipse(450, 290, 2, 2, 'F');
      doc.ellipse(440, 290, 2, 2, 'F');
      doc.ellipse(430, 290, 2, 2, 'F');
      doc.ellipse(420, 290, 2, 2, 'F');
      // center
      doc.ellipse(180, 290, 2, 2, 'F');
      doc.ellipse(170, 290, 2, 2, 'F');
      doc.ellipse(160, 290, 2, 2, 'F');
      doc.ellipse(150, 290, 2, 2, 'F');
      doc.ellipse(140, 290, 2, 2, 'F');
      doc.ellipse(130, 290, 2, 2, 'F');
      doc.ellipse(120, 290, 2, 2, 'F');
      doc.ellipse(110, 290, 2, 2, 'F');
      doc.ellipse(100, 290, 2, 2, 'F');
      doc.ellipse(90,  290, 2, 2, 'F');
      doc.ellipse(80, 290, 2, 2, 'F');
      doc.ellipse(70, 290, 2, 2, 'F');
      doc.ellipse(60, 290, 2, 2, 'F');
      doc.ellipse(50, 290, 2, 2, 'F');
      doc.ellipse(40, 290, 2, 2, 'F');
      doc.ellipse(30, 290, 2, 2, 'F');
      doc.ellipse(20, 290, 2, 2, 'F');
      doc.text(260, 293, "Comments");
